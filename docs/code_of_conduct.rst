...
El equipo del proyecto está obligado a mantener la confidencialidad respecto al reportante de un incidente.

Atribución
--------

Este Código de Conducta es una adaptación del `Contributor Covenant <https://www.contributor-covenant.org>`_, versión 2.0, disponible en https://www.contributor-covenant.org/es/version/2/0/code_of_conduct.html. 